  ...
  <div class="col-sm-3">
    <div class="card">
      <div class="card-body pb-3">
        ...
        <h5 class="card-title"><span className = "heading">Web</span> Design</h5>
        <p class="card-text pb-3">We will design responsive website in 10 hours.
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">Web Design</button>
      </div>
...
<div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Web Design</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">Web Design</button>
      </div>
      <div class="modal-body">
       WEB DESIGN
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">Web Design</button>
      </div>
    </div>
  </div>
</div>
<button class="btn btn-primary" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">WEB DESIGN</button>
  ...
  <div class="col-sm-3">
    <div class="card">
      <div class="card-body pb-3">
        ...
        <h5 class="card-title"> <span className = "heading">Web </span> Development</h5>
        <p class="card-text">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalToggleLabel">Web Development</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">Web Development</button>
      </div>
      <div class="modal-body">
      <video style = {{width:"100%"}} autoplay controls>
                <source src = {video} type = "video/mp4"/>
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal">Web Development</button>
      </div>
    </div>
  </div>
</div>
<div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Web Development</h1>
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">Web Development</button>
      </div>
    </div>
  </div>
</div>
<button class="btn btn-primary" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">Web Development</button>
  ...
  <div class="col-sm-3">
    <div class="card">
      <div class="card-body pb-3">
        ...
        <h5 class="card-title"><span className = "heading">IT</span> Support</h5>
        <p class="card-text">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalToggleLabel">IT Support</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <video style = {{width:"100%"}} autoplay controls>
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal">IT Support</button>
      </div>
    </div>
  </div>
</div>
<div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">IT Support</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        IT Support
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">IT Support</button>
      </div>
    </div>
  </div>
</div>
<button class="btn btn-primary" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">IT Support </button>
  ...
  <div class="col-sm-3">
    <div class="card">
      <div class="card-body">
        ...
        <h5 class="card-title"><span className = "heading">Graphic</span> Design</h5>
        <p class="card-text">we will do any kind of graphic design infographics, poster, flyer,
      banners, covers, edits.
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalToggleLabel">Graphic Design</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">Graphic Design</button>
      </div>
      <div class="modal-body">
      <video style = {{width:"100%"}} autoplay controls>
                <source src = {video} type = "video/mp4"/>
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal">Graphic Design</button>
      </div>
    </div>
  </div>
</div>
<div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Graphic Design</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">Graphic Design</button>
      </div>
      <div class="modal-body">
      Graphic Design
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">Graphic Design</button>
      </div>
    </div>
  </div>
</div>
